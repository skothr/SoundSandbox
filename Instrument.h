...
class Instrument : public Saveable
{
private:
protected:
public:
...
protected:
	...
	double				attackTime,			//Amount of time for sound to reach peak volume level (seconds)
	...
	double				attackInv = 0.0,	//Inverse of attackTime
